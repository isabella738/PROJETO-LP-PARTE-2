...
void exibir_tarefas(int k) { //recebe a posicao da pessoa no vetor e imprime todas as suas atividades
    ...
    if(k < 0 || k >= p) {
        printf("Erro: Colaborador invalido.\n");
        return;
    }
...
int main() {
    ...
    do {
        printf("\n=========================================================\n");
        printf("Escolha uma opcao do menu (1-11), ou 0 para encerrar o programa.\n> ");
...
int main() {
    ...
    do {
        ...
        if(escolha == 0) {
                            ...
                            for(i = 0; i < p; i++) { //cada pessoa
                                for(j = 0; j < pessoa[i].lim; j++) { //cada tarefa
                                    if(pessoa[i].tarefa[j].status == k) {
                                        contador++;
                                        printf("%d - %s (%s)\nEtapa: ", 
                                               contador, pessoa[i].tarefa[j].nome, pessoa[i].nome);user[tam] = i;
                                             item[tam] = j; 
                                             tam++;
                                   }
                                 }
            ...
            do {
                ...
                for(i = 0; i < pessoa[x].lim; i++) {
                    ...
                    if(status == 3) continue; // PULA tarefas concluidas em vez de parar
                ...
                if(pessoa[x].tarefa[t].status < 3) {
                    ...
                    printf("A tarefa ja esta concluida.\n");
                }
        ...
        else if(escolha == 9) { //Ranking - CORRIGIDO: array usados[100]
            printf("\n+-------------------------------------------------------+\n");
